...
def posts_new_form(user_id):
    """form to create a new post for user"""
...
def posts_new(user_id):
    """form submission for creating a new post for a specific user"""
...
def posts_destroy(post_id):
    """form submission for deleting post"""
